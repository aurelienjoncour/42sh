...
static void display_decimal_digits(const double decimal, int *decimal_len,
const int nb_decimal)
{
...
static double calc_decimal(const double nb, const int nb_decimal)
{
...
void my_put_double(const double nb, const int nb_decimal)
{
